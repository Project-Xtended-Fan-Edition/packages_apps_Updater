...
import org.xtended.generatebp.GenerateBpPlugin
import org.xtended.generatebp.GenerateBpPluginExtension
import org.xtended.generatebp.models.Module
...
buildscript {
    ...
    dependencies {
        classpath("org.xtended:gradle-generatebp:+")
    }
}
